...
<div class="py-16 bg-black">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style={{backgroundImage:"url('https://images.pexels.com/photos/4753996/pexels-photo-4753996.jpeg?auto=compress&cs=tinysrgb&w=800')"}}>
        </div>
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center">Welcome back to Fitness Cult</h2>
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    ...
                    <Link to= "/forgot-password"class="text-xs text-gray-500">Forget Password?</Link>
                </div>
